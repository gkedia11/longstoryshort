...
export const metadata: Metadata = {
  ...
  description:
    "Turn a genre and story idea into a complete fiction manuscript delivered by email in about 45 minutes.",
  ...
  openGraph: {
    title: "Longstory Short Story",
    description:
      "Complete AI fiction manuscripts from your genre and story idea for one simple price.",
